  ...
  return (
    <div className='w-full'>
        <div className="flex items-center gap-2 mb-2">
            ...
            <h1 className='text-tubeLight-effect overflow-x-hidden text-[1.3rem] sm:text-[1.7rem] md:text-[2.2rem] lg:text-[2.8rem] tracking-[12px]'>
                <Typewriter words={["FULLSTACK DEVELOPER", "WEB DEVELOPER", "FREELANCER"]} loop={50} cursor typeSpeed={70}
                deleteSpeed={70} 
                delaySpeed={100}/>
            </h1>
                <div className="w-fit px-5 py-2 bg-slate-50 rounded-[20px] flex gap-5 items-center mt-4 md:mt-8 lg:mt-10">
                    ...
                    <Link to={user.twitterURL} target='_blank'>
                        <Twitter className='text-cyan-500 w-7 h-7' />
                    </Link>
                </div>
