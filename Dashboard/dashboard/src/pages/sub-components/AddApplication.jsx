...
import { addNewSoftwareApllication, clearAllApplicationSliceErrors, getAllSoftwareApplications, resetApplicationSlice } from "@/store/slices/softwareApplicationSlice";
...
const AddApplication = () => {
  ...
  const handleAddNewApplication = (e) => {
    ...
    dispatch(addNewSoftwareApllication(formData));
  };
  ...
  return (
    <>
      <div className="-mt-12 flex justify-center items-center min-h-[100vh] sm:gap-4 sm:py-4 sm:pl-14">
        <form
                  ...
                  <div className="text-center">
                    {svgPreview ? (
                      <img
                        ...
                        viewBox="0 0 24 24"
                        src={svgPreview ? `${svgPreview}` : "/download.jpeg"}
                        alt="svg"
                      />
                    ) : (
                      <Image
