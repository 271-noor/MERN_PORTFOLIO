...
const AddSkill = () => {
  ...
  const handleAddNewSkill = (e) => {
    ...
    formData.append("proficciency", proficiency);
  ...
  return (
    <>
      <div className="flex justify-center items-center min-h-[100vh] mb-2 -mt-16 sm:gap-4 sm:py-4 sm:pl-14">
                  ...
                  <div className="text-center">
                      {
                        ...
                        viewBox="0 0 24 24" src={svgPreview ? `${svgPreview}` : "/download.jpeg"} alt="svg" /> :   <Image
                        aria-hidden="true"
