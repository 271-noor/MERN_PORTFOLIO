...
const UpdateProject = () => {
  ...
  return (
    <>
      <div className="flex justify-center items-center min-h-[100vh] -mt-4 sm:gap-4 sm:py-4 sm:pl-14">
        <form className="w-[100%] md:w-[1000px]" onSubmit={handleUpdateProject}>
          <div className="space-y-12">
            ...
            <div className="mt-4 ml-3 flex flex-col gap-5">
              <div className="w-full sm:col-span-4">
                <img
                  src={
                    projectBannerPreview ? projectBannerPreview : "/vite.jpg"
                  }
                  alt="projectBanner"
                  ...
                  >
                    ...
                    />
                            ...
                            <div className="flex justify-center w-full items-center">
                                  {
                                    loading ? <SpecialLoadingButt content={"Updating"} width={"w-52"} /> : <button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 w-52"
